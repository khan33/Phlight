...
let FORGOT_PASSWORD =   BASE_URL + "user/forget_password"
let VERIFY_EMAIL = BASE_URL + ""
let RESEND_EMAIL = BASE_URL + "user/resend_email"
let VERIFY_OTP_CODE = BASE_URL + "user/verify_code"
let RESEND_OTP = BASE_URL + "user/resend_code"
let ALL_STROE   = BASE_URL + "user/all_stores"
let SOCIAL_LOGIN = BASE_URL + "user/socialLogin"
let UPLOAD_IMG = BASE_URL + "user/imageUpload"
